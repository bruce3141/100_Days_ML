...
generations = 2
n_population_members = 10
n_contestants = 5  # n_population_members - 1
n_families = 2
...
# --- Search space:
C_min, C_max = 200, 1000
gamma_min, gamma_max = 0.01, 0.1
n_grid_steps = 20  # warining: this can take a while to run
...
# Take a peek at the distribution for C:
...
for g in range(generations):
    ...
    for f in range(n_families):
        ...
        for k in range(2):
            ...
            winner_indx = np.argmin(objective)
        ...
        # --- 2-point crossover:
        # ch_1, ch_2 = rd.sample(range(chrom_length), n_children)
